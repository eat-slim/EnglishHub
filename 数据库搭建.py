...
class DictionaryDB(object):
    ...
    def __CreateDB(self):
        ...
        CREATE UNIQUE INDEX IF NOT EXISTS "dictionary_id" ON stardict (id);
        CREATE UNIQUE INDEX IF NOT EXISTS "dictionary_word" ON stardict (word);
        CREATE INDEX IF NOT EXISTS "dictionary_sw" ON stardict (sw, word collate nocase);
